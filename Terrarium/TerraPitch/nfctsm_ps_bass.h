...
// Parameters set based on 48KHz sample rate and assuming lowest frequency in input signal being 30Hz
...
#define SEARCH_DOWNSAMPLE 9

using namespace daisysp;

class nfctsm_ps_bass
{
    public:
        nfctsm_ps_bass() {}
        ~nfctsm_ps_bass() {}
        ...
        void Init() { 
            ...
            lp_filt.Init();
            lp_filt.SetFrequency(0.009f); // 400Hz
    ...
    protected:
        ...
        const static size_t MAX_DELAY = 3200;
        const static size_t MIN_DELAY = 100;
        const static size_t BUF_SIZE = 6000;
        const size_t MAX_T = 1600;  // Period of 30hz in samples
        const size_t crossfade_len = 50;
        const static size_t L_CORR_WIN = 600;
        const size_t L_SEARCH_WIN = 1000;
